      ...
      @include('admin.header')
        ...
        <table class="table_deg">
            <tr class="th_deg">
                ...
                <th style="padding: 10px; color: black;">Product title</th>
                <th style="padding: 10px; color: black;">Quantity</th>
                <th style="padding: 10px; color: black;">Price</th>
                <th style="padding: 10px; color: black;">Payment Status</th>
                <th style="padding: 10px; color: black;">Delivery Status</th>
                <th style="padding: 10px; color: black;">Image</th>
                <th style="padding: 10px; color: black;">Delivered</th>
                <th style="padding: 10px; color: black;">Print PDF</th>
                <th style="padding: 10px; color: black;">Send Email</th>
            </tr>
